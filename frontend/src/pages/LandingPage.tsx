      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 pt-16 md:pt-32 pb-16 text-center">
          <p className="text-sm font-semibold text-brand-violet uppercase tracking-widest mb-6">
            A Portfolio Project by <a href="https://www.tasfiqj.com/" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-80">Tasfiq Jasimuddin</a>
          </p>
      ...
      <section className="max-w-4xl mx-auto px-5 py-20 text-center">
        <div className="space-y-6">
          ...
          <p className="text-sm text-txt-3">
            Built by <a href="https://www.tasfiqj.com/" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-80 text-txt-2">Tasfiq Jasimuddin</a>
          </p>
        </div>
      </section>
    </div>
